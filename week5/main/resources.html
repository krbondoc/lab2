...
<body>
    ...
    <div class="contents">
        <h1>RESOURCES</h1>
        <h4>Websites</h4>
        <p>Google Font (https://fonts.google.com):<br>- Forum, cursive<br>- Sevillana, cursive<br>- Cinzel Decorative, cursive</p>
        <p>W3Schools CSS Gallery Template (https://www.w3schools.com/css/css_image_gallery.asp)</p>
        <p>W3Schools HTML & CSS Course:<br>- HTML Tutorial (https://www.w3schools.com/html/default.asp)<br>- CSS Tutorial (https://www.w3schools.com/css/default.asp)</p>
        <h4>Images</h4>
        <p>Alpha Coders: Pixel Forest GIF (https://gifs.alphacoders.com/gifs/view/215595)</p>
        <p>Personal Twitter and Instagram Account:<br><i>REDACTED due to privacy.</i></p>
      </div>
  </section>
  <section>
